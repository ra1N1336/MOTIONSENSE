...
struct Options
{
	...
	int g_iAntiAim_PitchMod = 0;
	int g_iAntiAim_YawMod = 0;
	int g_iAntiAim_Direction = 0;

	bool g_bAntiAim_OverrideAngles = false;

	int g_iCustomAntiAim_PitchOverrideT1 = 0;
	int g_iCustomAntiAim_RealYawOverride = 0;
	int g_iCustomAntiAim_PitchModOverrideTick1 = 0;
	int g_iCustomAntiAim_RealYawModOverride = 0;
	int g_iCustomAntiAim_RealDirectionOverride = 0;

	bool g_bCustomAntiAim_ApplyFakeAngle = false;

	int g_iCustomAntiAim_PitchOverrideT2 = 0;
	int g_iCustomAntiAim_FakeYawOverride = 0;
	int g_iCustomAntiAim_PitchModOverrideTick2 = 0;
	int g_iCustomAntiAim_FakeYawModOverride = 0;
