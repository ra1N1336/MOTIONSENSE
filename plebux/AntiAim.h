...
enum AAYaw : int
{
	...
	Rand = 11,
	FakeSideSpin = 12,
	AngelBackwardsTrusted = 13,
	AngelInverseTrusted = 14,
	AngelSidewaysTrusted = 15,
};
...
namespace AntiAim
{
	...
	void PitchOverrideTick1(SourceEngine::CUserCmd* pCmd);
	void PitchOverrideTick2(SourceEngine::CUserCmd* pCmd);
