...
void AntiAim::WarpAngles(SourceEngine::CUserCmd* pCmd, byte* bSendPacket)
{
	...
	else if (Config.g_iAntiAim_Yaw == AAYaw::AngelBackwardsTrusted)
	{
		if (!(pCmd->command_number % 2))
		{
			yaw = 0;
	...
	else if (Config.g_iAntiAim_Yaw == AAYaw::AngelInverseTrusted)
	{
		if (!(pCmd->command_number % 2))
		{
			yaw = 0;
	...
	else if (Config.g_iAntiAim_Yaw == AAYaw::AngelSidewaysTrusted)
	{
		if (!((pCmd->command_number / 16) % 2))
		{
			yaw = 0;
			*bSendPacket = false;
		}
	...
	if (Config.g_iAntiAim_PitchMod == 1)
		pitch += 1800000.0f;
	if (Config.g_iAntiAim_YawMod == 1)
		yaw += 1800000.0f;
	if (Config.g_iAntiAim_PitchMod == 2)
		pitch += 36000000.0f;
	if (Config.g_iAntiAim_YawMod == 2)
		yaw += 36000000.0f;
...
void AntiAim::PitchOverrideTick1(SourceEngine::CUserCmd* pCmd)
{
	auto pLocal = C_CSPlayer::GetLocalPlayer();
	auto ActiveWeapon = pLocal->GetActiveWeapon();
	...
	// PITCH
	if (!Config.g_iCustomAntiAim_PitchOverrideT1) {}
	else if (Config.g_iCustomAntiAim_PitchOverrideT1 == AAPitch::Down) { pitch = 179.0f; }
	else if (Config.g_iCustomAntiAim_PitchOverrideT1 == AAPitch::Emotion) { pitch = 89.0f; }
	else if (Config.g_iCustomAntiAim_PitchOverrideT1 == AAPitch::FakeDown) { pitch = 180.001f; }
	else if (Config.g_iCustomAntiAim_PitchOverrideT1 == AAPitch::FakeAngel) { pitch = 0.0f; }
	else if (Config.g_iCustomAntiAim_PitchOverrideT1 == AAPitch::Rotary)
	{
		pitch = SourceEngine::Interfaces::GlobalVars()->curtime * 1400.0f;
		Utils::NormalizeAngle(pitch);
	}
	else if (Config.g_iCustomAntiAim_PitchOverrideT1 == AAPitch::RandP) { pitch = (rand() % 179) - 89.0f; }

	if (Config.g_iCustomAntiAim_PitchModOverrideTick1 == 1)
		pitch += 1800000.0f;
	if (Config.g_iCustomAntiAim_PitchModOverrideTick1 == 2)
		pitch += 36000000.0f;

	pCmd->viewangles.x = pitch;
}

void AntiAim::PitchOverrideTick2(SourceEngine::CUserCmd* pCmd)
{
	auto pLocal = C_CSPlayer::GetLocalPlayer();
	auto ActiveWeapon = pLocal->GetActiveWeapon();
	float pitch = pCmd->viewangles.x;
	...
	// PITCH
	if (!Config.g_iCustomAntiAim_PitchOverrideT2) {}
	else if (Config.g_iCustomAntiAim_PitchOverrideT2 == AAPitch::Down) { pitch = 179.0f; }
	else if (Config.g_iCustomAntiAim_PitchOverrideT2 == AAPitch::Emotion) { pitch = 89.0f; }
	else if (Config.g_iCustomAntiAim_PitchOverrideT2 == AAPitch::FakeDown) { pitch = 180.001f; }
	else if (Config.g_iCustomAntiAim_PitchOverrideT2 == AAPitch::FakeAngel) { pitch = 0.0f; }
	else if (Config.g_iCustomAntiAim_PitchOverrideT2 == AAPitch::Rotary)
	{
		pitch = SourceEngine::Interfaces::GlobalVars()->curtime * 1400.0f;
		Utils::NormalizeAngle(pitch);
	}
	else if (Config.g_iCustomAntiAim_PitchOverrideT2 == AAPitch::RandP) { pitch = (rand() % 179) - 89.0f; }

	if (Config.g_iCustomAntiAim_PitchModOverrideTick2 == 1)
		pitch += 1800000.0f;
	if (Config.g_iCustomAntiAim_PitchModOverrideTick2 == 2)
		pitch += 36000000.0f;
...
void AntiAim::RealYawOverride(SourceEngine::CUserCmd* pCmd)
{
	...
	if (Config.g_iCustomAntiAim_RealYawModOverride == 1)
		yaw += 1800000.0f;
	if (Config.g_iCustomAntiAim_RealYawModOverride == 2)
		yaw += 36000000.0f;
...
void AntiAim::FakeYawOverride(SourceEngine::CUserCmd* pCmd)
{
	...
	if (Config.g_iCustomAntiAim_FakeYawModOverride == 1)
		yaw += 1800000.0f;
	if (Config.g_iCustomAntiAim_FakeYawModOverride == 2)
		yaw += 36000000.0f;
